...
describe('Plugin', () => {
    describe('constructor', () => {
        ...
        it('should set template property of instance', () => {
            // Act
            const instance = new Plugin(serverless);

            // Assert
            expect(instance.template).toEqual(serverless.service.provider.compiledCloudFormationTemplate);
        });
        ...
        it('should set correct hook in serverless instance', () => {
            ...
            expect(serverless.pluginManager.hooks).toEqual({
                'after:aws:package:finalize:mergeCustomProviderResources': {
                    pluginName: 'serverless-plugin-time-substitution',
    ...
    describe('handle', () => {
        ...
        beforeEach(() => {
            const serverless = {
                ...
                service: {
                    provider: {
                        compiledCloudFormationTemplate: null,
                    },
                },
            };
        ...
        it('should do nothing if intance.template is null', () => {
            // Arrange
            systemUnderTest.serverless.service.provider.compiledCloudFormationTemplate = {}
            systemUnderTest.template = null;
