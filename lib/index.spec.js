...
describe('Plugin', () => {
    ...
    describe('log', () => {
        ...
        beforeEach(() => {
            systemUnderTest.serverless.cli.log.mockReset();
        });

        it('should call serverless.cli.log method with message and class name', () => {
            // Arrange
            ...
            // Assert
            expect(systemUnderTest.serverless.cli.log).toHaveBeenCalledWith(message, 'ServerlessPluginTimeSubstitution');
        });
    });
});
